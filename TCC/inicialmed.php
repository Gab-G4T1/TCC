...
<body>
    ...
    <main>
                ...
                <div class="container">
                    <div class= "item">
                    <a href="verconsultas.php"><img src="icon1.png" alt="Agendamento" style="width: 300px; height: 300px;"></a>
                    <h4>Ver consultas</h4>
                </div>
                <div>
                    <a href="verexames.php"><img src="icon2.png" alt="Exames" style="width: 300px; height: 300px;"></a>
                    <h4>Ver Exames</h4>
                </div>
                <div class="item">
                    <a href="perfilmed.php"><img src="icon4.png" alt="Usuário" style= "width: 300px; height: 300px;"></a>
